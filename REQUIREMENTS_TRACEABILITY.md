...
| 77 | Loki live capability gated honestly; no faking | 18.3, 24.14 | D, J | Partial | Phase D: LokiProperties#liveTailSupported (default false, config-gated); LokiLogSource#capabilities().liveTail() reflects it honestly, never faked (LokiLogSourceTest#capabilitiesReflectConfiguredFlagsHonestlyWhen*). Actual live-tail transport is Phase J's job, not yet built. |
