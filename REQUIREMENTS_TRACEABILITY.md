...
| 2 | Two logical sources (Docker, OpenShift Loki) | 1 | C, D | Partial | Docker half done: source/LogSource.java (SPI, Phase B) + source/docker/DockerLogSource.java (id="local-docker"). DockerLogSourceTest (14 tests) + real end-to-end verification against live local Docker containers (docs/verification/PHASE_C_REPORT.md). Loki half not yet built (Phase D). |
