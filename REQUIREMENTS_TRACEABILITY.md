...
| 2 | Two logical sources (Docker, OpenShift Loki) | 1 | C, D | Missing | Absent — repo contains no application code (backend/ and frontend/ do not exist). docs/AUDIT.md §5 row 2. |
...
| 4 | Remote Docker default port prefilled | 11, 20.2 | C | Missing | Absent — repo contains no application code (backend/ and frontend/ do not exist). docs/AUDIT.md §5 row 4. |
| 5 | Remote Docker custom port supported | 11, 24.3 | C | Missing | Absent — repo contains no application code (backend/ and frontend/ do not exist). docs/AUDIT.md §5 row 5. |
| 6 | Remote Docker TLS optional | 11.1, 24.2 | C | Missing | Absent — repo contains no application code (backend/ and frontend/ do not exist). docs/AUDIT.md §5 row 6. |
| 7 | Remote Docker reachability lesson honored (no 2375 prerequisite) | 11.2, 24.1 | C, K | Missing | Absent — repo contains no application code (backend/ and frontend/ do not exist). docs/AUDIT.md §5 row 7. |
| 8 | Java 21 / Spring Boot 3.x / WebFlux | 4.1 | A, B | Missing | Absent — repo contains no application code (backend/ and frontend/ do not exist). docs/AUDIT.md §5 row 8. |
...
| 10 | No MVP database; safe localStorage only | 4.4 | B, F | Missing | Absent — repo contains no application code (backend/ and frontend/ do not exist). docs/AUDIT.md §5 row 10. |
...
| 12 | Canonical top-level fields mapped | 5, 5.1 | B | Missing | Absent — repo contains no application code (backend/ and frontend/ do not exist). docs/AUDIT.md §5 row 12. |
| 13 | All expected MDC fields handled | 5 | B | Missing | Absent — repo contains no application code (backend/ and frontend/ do not exist). docs/AUDIT.md §5 row 13. |
| 14 | Literal dotted key `event.correlationId` read safely | 5.1 | B | Missing | Absent — repo contains no application code (backend/ and frontend/ do not exist). docs/AUDIT.md §5 row 14. |
| 15 | Correlation precedence (X-Correlation-id → event.correlationId) | 5.1 | B | Missing | Absent — repo contains no application code (backend/ and frontend/ do not exist). docs/AUDIT.md §5 row 15. |
| 16 | Unknown JSON/MDC fields preserved | 5.3 | B | Missing | Absent — repo contains no application code (backend/ and frontend/ do not exist). docs/AUDIT.md §5 row 16. |
| 17 | Malformed lines become raw fallback events | 5.4 | B | Missing | Absent — repo contains no application code (backend/ and frontend/ do not exist). docs/AUDIT.md §5 row 17. |
| 18 | Timestamp normalization to Instant, no double conversion | 5.5 | B | Missing | Absent — repo contains no application code (backend/ and frontend/ do not exist). docs/AUDIT.md §5 row 18. |
| 19 | Sensitive field masking before browser serialization | 6.1 | B | Missing | Absent — repo contains no application code (backend/ and frontend/ do not exist). docs/AUDIT.md §5 row 19. |
| 20 | Never log search values, tokens, raw identifiers, events | 6.2 | B + every phase | Missing | Absent — repo contains no application code (backend/ and frontend/ do not exist). docs/AUDIT.md §5 row 20. |
...
| 22 | Explicit source capability model | 7 | B | Missing | Absent — repo contains no application code (backend/ and frontend/ do not exist). docs/AUDIT.md §5 row 22. |
| 23 | Source registry and API endpoints | 7 | B | Missing | Absent — repo contains no application code (backend/ and frontend/ do not exist). docs/AUDIT.md §5 row 23. |
| 24 | Bounded query guardrails | 8.1 | B | Missing | Absent — repo contains no application code (backend/ and frontend/ do not exist). docs/AUDIT.md §5 row 24. |
| 25 | Per-source maximum time range | 8.1 | B | Missing | Absent — repo contains no application code (backend/ and frontend/ do not exist). docs/AUDIT.md §5 row 25. |
| 26 | Result limit with configurable max (≤ 5,000) | 8.1 | B | Missing | Absent — repo contains no application code (backend/ and frontend/ do not exist). docs/AUDIT.md §5 row 26. |
| 27 | Bounded concurrency | 8.1 | B | Missing | Absent — repo contains no application code (backend/ and frontend/ do not exist). docs/AUDIT.md §5 row 27. |
| 28 | Cancellation propagated | 8.1, 18.2 | B, J | Missing | Absent — repo contains no application code (backend/ and frontend/ do not exist). docs/AUDIT.md §5 row 28. |
...
| 31 | Docker Compose label discovery + service counts | 10 | C | Missing | Absent — repo contains no application code (backend/ and frontend/ do not exist). docs/AUDIT.md §5 row 31. |
| 32 | Docker stream framing decoded correctly (incl. tty) | 10 | C | Missing | Absent — repo contains no application code (backend/ and frontend/ do not exist). docs/AUDIT.md §5 row 32. |
| 33 | Docker operations strictly read-only | 10 | C | Missing | Absent — repo contains no application code (backend/ and frontend/ do not exist). docs/AUDIT.md §5 row 33. |
