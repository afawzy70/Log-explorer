...
class SourceHealthLeakTest {
  ...
  void aRawConnectionFailureMessageNeverReachesTheSerializedHealthDto() throws Exception {
    ...
    SourceHealthDto dto = SourceHealthDto.of(health, 5L, new SourceCapabilities(true, true, false, true, false, false, false, true));
  ...
  void degradedWarningsAreTheFixedSanitizedStringNeverEnvironmentSpecificDetail() throws Exception {
    ...
    SourceHealthDto dto = SourceHealthDto.of(health, 3L, new SourceCapabilities(true, true, false, true, false, false, false, true));
